    ...
    <div className="overlay" role="dialog" aria-modal="true" aria-labelledby="rules-title">
      <div className="overlay-card">
        ...
        <ul>
          ...
          <li>Play now uses your last category, or today’s mix. Play vs random finds another signed-in player in one shared queue — you don’t both need the same topic.</li>
